...
- [x] 6.1 使用 `React + TypeScript + Vite` 实现三页式前端 demo：本体数据导入与自动化建模、本体查看与管理、基于本体的 Agent 业务问答
- [x] 6.2 在本体查看与管理页使用交互式图谱组件呈现异构本体结构，并将元数据/逻辑体编辑下沉到抽屉或次级窗口
- [x] 6.3 实现 Agent 问答页的左侧对话、右侧上下文区、推理链区和报告区布局
- [x] 6.4 实现三页之间共享的 domain 上下文、当前资源选中状态和最近一次问答结果
